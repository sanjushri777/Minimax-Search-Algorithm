            ...
            if self.player_turn == 'X':
                while True:
                    ...
                    try:
                        ...
                        py = int(input('Enter the Y coordinate (0-2): '))
                    except ValueError:
...
![image](https://github.com/user-attachments/assets/218a3489-3c01-4824-ae88-a26de9af1c39)

![image](https://github.com/user-attachments/assets/e2c606d0-deee-4555-be38-76c9217157a9)

![image](https://github.com/user-attachments/assets/ecd9b0ab-469a-4031-b556-e83ca8c485f9)

![image](https://github.com/user-attachments/assets/ab18107a-0474-4cfa-ba22-e1a4cf00179c)
